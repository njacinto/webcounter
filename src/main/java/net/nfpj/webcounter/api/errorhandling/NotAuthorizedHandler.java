...
public class NotAuthorizedHandler implements ExceptionMapper<NotAuthorizedException> {
    private static final Logger log = LoggerFactory.getLogger(NotAuthorizedHandler.class);

    @Override
    public Response toResponse(NotAuthorizedException exception) {
        log.warn("Not Authorized error catched: " + exception.getMessage(), exception);
        //
